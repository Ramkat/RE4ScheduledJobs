'Filename    : AnalyseEmailLogs.vbs
'Author      : Christo Pretorius
'Date        : 30 June 2004
'Description : This script will run the cmd line to analyse the Email logs.
...
strLogFilesPath = "D:\IIS Logs\Email\SMTPSVC1"
...
'Analyse the logs
strCmd = "D:\LogAnalysers\IIS_5_Email_Log_Analyser.exe " & strLogFilesPath & "\" & strLogFiles & ",D:\Webs\EmailStats"

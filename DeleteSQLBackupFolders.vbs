'Filename    : DeleteSQLBackupFolders.vbs
'Author      : Christo Pretorius
'Date        : 9 Nov 2020
'Description : This script will remove SQL backup folders that are older than conBackupDays.

Option Explicit

CONST conBackupFolder = "D:\SQLBackups"
CONST conBackupDays = 14	'Number of days to keep the backups.
...
fileName = "DeleteSQLBackupFolders-" & strGetDateAsNumerics(Now) & ".log"
...
For Each SubFolder In objSubFolders	
	...
	If Err.Number = 0 Then	
		...
		'If the sub folder is older than conBackupDays or its name is the date minus conBackupDays, delete it.
